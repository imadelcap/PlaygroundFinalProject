...
from appStock.views import formulario_accesorio, formulario_modelo_bicicleta, buscar_accesorio, buscar_modelo_bicicleta, listar_accesorios, listar_bicicletas, eliminar_accesorio, eliminar_bicicleta
